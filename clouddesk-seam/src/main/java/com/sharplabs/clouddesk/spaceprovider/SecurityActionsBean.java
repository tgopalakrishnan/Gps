...
import com.sharplabs.clouddesk.spaceprovider.PrincipalListManager;
/**
 * Provides security related methods.
 *
 * @author Razvan Caraghin
 */
@Name("cdsecurityActions")
@Scope(CONVERSATION)
public class SecurityActionsBean extends InputController implements
    ...
    @In(create = true)
    protected PrincipalListManager cdprincipalListManager;
    ...
    protected UserPermissionsTableRow createDataTableRow(String user)
        ...
        String principalType = cdprincipalListManager.getPrincipalType(user);
    ...
    public Map<String, String> getIconAltMap() {
        return cdprincipalListManager.iconAlt;
    }

    public Map<String, String> getIconPathMap() {
        return cdprincipalListManager.iconPath;
    }
